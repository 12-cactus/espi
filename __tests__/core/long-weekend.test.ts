...
import { InfoDay, LongWeekend, groupByCloseness, longWeekendMap } from '../../src/core/long-weekend';
...
describe('Testing module long-weekend', () => {
  ...
  describe('groupByCloseness :: TypedDay[] -> TypedDay[][]', () => {
    test('should work', () => {
      ...
      expect(groupByCloseness([day1, day2, day4])).toStrictEqual([[day1, day2], [day4]]);
      expect(groupByCloseness([day1, day2, day4, day5, day9])).toStrictEqual([[day1, day2], [day4, day5], [day9]]);
    });
  });
});
